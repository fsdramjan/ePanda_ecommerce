...
class AppConfig {
  static String copyright_text = "@ ePanda Ecommerce " + this_year; //this shows in the splash screen
  static String app_name = "ePanda Ecommerce"; //this shows in the splash screen
  static String purchase_code = "c388fd42-c9de-4d7b-879b-1ed3e84b829f"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "epanda.com.bd"; //localhost
